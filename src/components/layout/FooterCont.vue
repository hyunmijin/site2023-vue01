<template>
  <footer
    id="footer"
    role="contentinfo"
    class="footer__wrap cafe5 section bg-blue"
  >
    <div class="footer__inner container">
      <div class="footer__text">
        ...
        <p>
          궁금한 사항은 메일로 연락주세요!
          <router-link to="mailto:webstoryboy@naver.com"
            >hunmi961119@gmil.com</router-link
          >
        </p>
        <ul class="sns">
          <li>
      ...
      <div class="footer__menu">
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <router-link to="/">퀴즈 이팩트</router-link>
            </li>
            <li>
      ...
      <div class="footer__right">
        Copyright 2022. All Rights Reserved. - Designed by JHM
      </div>
    </div>
  </footer>
</template>
